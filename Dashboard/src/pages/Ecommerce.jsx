      ...
      >
        <div
          className="bg-white 
            ...
            bg-hero-pattern bg-no bg-cover
            bg-center"
        >
          <div className="flex justify-between items-center">
            <div>
              <p className="font-bold">Earnings</p>
              <p className="text-2xl">$63, 447.89</p>
            </div>
          </div>
          <div className="mt-6">
            <Button
          ...
          {earningData.map((item) => (
            ...
            >
              <button
               ...
               rounded-full p-4 hover:drop-shadow-lg
              "
              >
                {item.icon}
              </button>
        ...
        >
          ...
          >
            <div className="border-r-1 border-color m-4 pr-10">
              <div>
                <p>
                  <span className="text-3xl font-semibold">$89,88</span>
                  <span
              ...
              <div className="mt-8">
                <p>
                  <span className="text-3xl font-semibold">$59,88</span>
                </p>
